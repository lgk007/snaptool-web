  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-4 py-8">
      ...
      <TransitionGroup name="tool-card" tag="div" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div
          v-for="(tool, index) in developmentTools"
          :key="tool.id"
...
// 获取开发工具数据
const developmentTools = computed(() => {
  return allTools.filter(tool => tool.category === 'development').map(tool => ({
    id: tool.id,
