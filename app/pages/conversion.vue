  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-4 py-8">
      ...
      <TransitionGroup name="tool-card" tag="div" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div
          v-for="(tool, index) in conversionTools"
          :key="tool.id"
...
// 获取转换工具数据
const conversionTools = computed(() => {
  return allTools.filter(tool => tool.category === 'conversion').map(tool => ({
    id: tool.id,
